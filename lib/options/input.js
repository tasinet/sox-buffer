...
module.exports = function(proto) {
	...
	proto.input = function(inputSource) {
		...
		if (typeof inputSource !== 'string') {
			if (inputSource instanceof Buffer) {
			      isStream = true
			      const inputBuffer = inputSource;
			      //create readable stream from buffer
			      inputSource = new Readable();
			      inputSource._read = () => {};
			      inputSource.pause()
			      inputSource.push(inputBuffer);
			      inputSource.push(null);
			} else if (('readable' in inputSource) || inputSource.readable) {
			      isStream = true
			      inputSource.pause()
			} else {
